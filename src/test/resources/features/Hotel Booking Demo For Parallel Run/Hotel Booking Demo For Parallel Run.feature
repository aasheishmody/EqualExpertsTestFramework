@bookingDemo
Feature: Hotel Booking Demo for Parallel Run
  ...
  Scenario Outline: Parallel Run Demo - Booking can be made on the 'Hotel booking form' page with/without deposit
    ...
    Examples:
      | firstname | surname | price   | deposit | check-in   | check-out  |
      | Krishna   | Das     | jdhfdjk | true    | Today      | Tomorrow   |
      | Gopal     | Chand   | 200     | false   | 2017-09-27 | 2017-09-28 |


  Scenario Outline: Parallel Run Demo - Booking can be deleted on the 'Hotel booking form' page
  ...
  Scenario Outline: Parallel Run Demo - Calendar modal is displayed for the <field> on the 'Hotel booking form' page
